...
The fit method takes two parameters:  The variables that we use to build the model and the known quantity that we are trying to fit the model against.
